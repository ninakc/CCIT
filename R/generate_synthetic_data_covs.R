...
#' @param gps_spec: propensity score / treatment function of data generating process (possible values: 1, 2)
generate_syn_data_covs <- function(sample_size=10000, gps_spec = 1) {
  ...
  simulated_covariates <- mutate(
    as.data.frame(cf),
    cf5 = cf5, cf6 = cf6, em1 = em1, em2 = em2, em3 = em3, em4 = em4, treat = treat
  )
